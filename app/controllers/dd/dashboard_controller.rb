class Dd::DashboardController < DdController

  include Dd::Dashboard::NewsController
  ...
  def destroy
    ...
    if @post && current_user.can_delete_post?(@post)
      ...
      @post.delete_me!
      redirect_to_with_notice dd_dashboard_index_path, t('notices.post_deleted')
    else
      redirect_to_with_notice dd_dashboard_index_path, t('notices.cannot_post_delete')
    end
  end
